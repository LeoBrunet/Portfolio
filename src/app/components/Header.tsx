  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-start justify-between max-w-4xl mx-auto w-full gap-8 relative">
          <div className={`
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex gap-4 text-white/80 text-sm md:text-base">
                ...
                <a href="/cv.pdf" download className="hover:text-white transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
